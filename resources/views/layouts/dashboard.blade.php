            ...
            <div class=" w-full flex relative items-center text-right float-right justify-end ">
                <div class="p-2 flex absolute">
                    <button onclick="notification()"
                        class="rounded-full hover:bg-gray-400 focus:shadow-md focus:outline-none flex md:mr-4">
        ...
        <div class="mx-full flex min-h-screen  relative">
            ...
            <div class="main-content md:w-10/12 w-full mx-10">
                ...
                <div class="container">
                    ...
                    <!--Toast-->
                    <div
                        class="alert-toast fixed bottom-auto md:top-0 right-0 m-8 w-5/6 md:w-full max-w-sm items-center">
