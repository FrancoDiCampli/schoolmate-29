        ...
        <div class="top-navbar w-full mx-auto flex items-center  bg-gray-200 p-3 border-b border-gray-400">
            ...
            <div class="">
              <h1 class="text-bluedark-400 font-rubik text-2xl ml-12 mr-10 w-auto hidden md:block">Félix<span class="font-semibold">Frías</span></h1>
                <span class="text-bluedark-400 font-rubik text-md ml-12 mr-10 w-auto hidden md:block text-center">UEP N° 28</span>
            </div>


            <div class=" w-full flex relative items-center text-right float-right justify-end ">
                <div class="p-2 flex absolute">
                    <button id="boton" class="rounded-full hover:bg-gray-400 focus:shadow-md focus:outline-none flex md:mr-4 hidden md:flex" >
                    ...
                    <p class="tooltip z-50">
                        ...
                        <span class="tooltip-text hidden md:block bg-gray-600 m-2 -mx-24 absolute text-center text-xs p-1 text-white rounded-md shadow-md">Nombre del Usuario</span>
                    </p>
            ...
            <div class="relative md:w-0 w-2/12 text-right">
                ...
                <button onclick="setRes()" class="md:hidden text-gray-700 mt-2 ml-2 mr-3 hover:text-gray-900 focus:outline-none">
