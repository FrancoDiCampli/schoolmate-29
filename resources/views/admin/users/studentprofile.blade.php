    ...
    <div class="card-title bg-white w-full p-5 border-b items-center justify-between">
        ...
        <div class="md:flex w-full mt-4">
            ...
            <div class="pt-3 text-center md:text-left">
                ...
                <p class="mx-2 text-gray-600 text-sm">Legajo: @if($user->student->docket) {{$user->student->docket}} @else S/L @endif</p>
            </div>
        ...
        <form method="POST" action="{{ route('update.student',$user->student)}}" enctype="multipart/form-data" class="mx-auto" >
            ...
            <div class="flex flex-wrap my-5">
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input id="dni" type="text"  name="dni" class="form-input w-full block"
                        type="text" placeholder="Ej: 22212222" value="{{$user->student->dni}}" @role('teacher|student') readonly @endrole>
                    <span class="flex italic text-gray-600  text-xs" role="alert">
            ...
            <div class="flex flex-wrap my-5">
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input type="date" max="{{now()->subYear(3)->format('Y-m-d')}}" id="start" name="fnac" class="form-input w-full block" id="grid-last-name" type="text"
