...
<div class="md:flex w-full mt-4">
    <div class="z-50">
        ...
        <img class="w-24 h-24 rounded-full object-cover border-4 border-gray-200 mx-auto md:mr-4"
            src="{{asset($user->teacher->photo)}}" alt="avatar">
        @else
    ...
    <div class="pt-3 text-center md:text-left">
        ...
        <p class="mx-2 text-gray-600 text-sm">Legajo: @if($user->teacher->docket) {{$user->teacher->docket}} @else S/L
            @endif</p>
    </div>
...
<div class="card-body py-5 px-4">
    ...
    <form method="POST" action="{{ route('update.teacher',$user->teacher)}}" enctype="multipart/form-data"
        class="mx-auto">
        @method('PUT')
        @csrf
        ...
        <div class="flex flex-wrap my-5">
            ...
            <div class="w-full md:w-1/2 px-3">
                ...
                <input id="dni" type="text" name="dni" class="form-input w-full block" type="text"
                    placeholder="Ej: 22212222" value="{{$user->teacher->dni}}" @role('teacher|student') readonly
                    @endrole>
                <span class="flex italic text-gray-600  text-xs" role="alert">
            ...
            <div class="w-full md:w-2/2 px-3 mt-5">
                ...
                <input id="password" type="password" minlength="8" name="password" class="form-input w-full block" value="" placeholder="Ingresar nueva contraseña">
                
                <div class="flex items-center text-gray-700 pt-1" id="mostrarpass" style="display: flex">
                    <p class="mr-2">Contraseña oculta</p>
                ...
                <div class="flex items-center text-gray-700 pt-1" style="display: none" id="ocultarpass">
                    <p class="mr-2">Contraseña visible</p>
                    <button class="" type="button" onclick="mostrarContrasena()">
                        <svg class="w-6 h-6 text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex flex-wrap my-5">
            ...
            <div class="w-full md:w-1/2 px-3">
                ...
                <input type="date" max="{{now()->subYear(17)->format('Y-m-d')}}" id="start" name="fnac"
                    class="form-input w-full block" id="grid-last-name" type="text" value="{{ $user->teacher->fnac}}">
