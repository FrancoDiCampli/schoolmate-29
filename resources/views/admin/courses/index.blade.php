    ...
    <div class="card  rounded-sm bg-gray-100 mx-auto mt-6 shadow-lg">
        ...
        <div class="card-body py-2">
            ...
            {{-- <table class="text-gray-700">
                <thead>
                    <tr class="text-center">
                        ...
                        <th class="md:w-5/12 w-2/12 px-10 ">Curso</th>
                        <th class="w-3/12 ">Codigo</th>
                ...
                <div class="flex justify-center">
                    <a href="{{route('courses.edit', $course->id)}} " class="mx-1 text-primary-400">
                        <svg aria-hidden="true" data-prefix="fas" data-icon="pencil-alt"
                            class="h-4 w-4 svg-inline--fa fa-pencil-alt fa-w-16" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                    ...
                    <a href="" class="mx-1 text-secondary-400">
                        <svg aria-hidden="true" data-prefix="fas" data-icon="trash-alt"
                            class="h-4 w-4 svg-inline--fa fa-trash-alt fa-w-14" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 448 512">
                            <path fill="currentColor"
            ...
            <div class="overflow-x-auto m-4 shadow">
                ...
                @else
                <h1>No podee cursos registrados</h1>
                @endif
            </div>
        </div>
