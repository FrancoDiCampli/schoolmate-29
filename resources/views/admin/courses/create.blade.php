            ...
            <form method="POST" action="{{ route('courses.store') }}" class="mx-auto">
                ...
                <div class="md:flex">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <select id="anio" onchange="setCode()" name="year"
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <select id="division" onchange="setCode()" id="" name="division"
                                class="block hover:bg-gray-300 appearance-none w-full bg-gray-200 border-gray-200 text-gray-700 py-3 px-4 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-primary-400 border-b-2"
                                id="grid-state">
                ...
                <div class="flex flex-wrap my-5">
                    <div class="w-full md:w-1/2 px-3 md:mb-0 mb-6 ">
                        ...
                        <input type="text" id="name" name="name" class="form-input w-full block" id="grid-last-name"
                            type="text" placeholder="Doe" value="{{old('name')}}">
...
<script>
    function setCode(){
        let a = ["Cero","Primero", "Segundo", "Tercero", "Cuarto","Quinto"];
        let y = new Date();
        let n = y.getFullYear();
