...
<div class="card md:w-10/12 rounded-sm bg-gray-100 mx-auto mt-6 mb-4 shadow-lg">
    <div class="card-title bg-white w-full p-5 border-b flex items-center justify-between">
        <div>
            <p class="sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-semibold placeholder-gray-700">Tareas
                Pendientes</p>
        ...
        <div class=" w-full flex relative items-center ">
            ...
            <div class="w-auto md:w-6/12 text-right mr-2 flex items-center justify-end">
                ...
                <svg aria-hidden="true" data-prefix="fas" data-icon="exclamation-circle"
                    class="w-5 h-5 ml-4 md:ml-none text-orange-600 svg-inline--fa fa-exclamation-circle fa-w-16"
                ...
                <svg aria-hidden="true" data-prefix="far" data-icon="clock"
                    class="w-5 h-5 ml-4 md:ml-none text-red-600 svg-inline--fa fa-clock fa-w-16"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="currentColor"
...
<svg aria-hidden="true" data-prefix="fas" data-icon="file-download"
    class="h-12 w-12 svg-inline--fa fa-file-download fa-w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
    <path fill="currentColor"
