...
<div class="container font-montserrat text-sm mb-8">
    <div class="card  rounded-sm bg-gray-100 mx-auto mt-6 shadow-lg md:w-10/12">
        <div class="card-title bg-white w-full p-5 border-b flex items-center justify-between md:justify-between">
            <div>
                <p class="sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-semibold placeholder-gray-700">Nueva Tarea
                </p>
            ...
            <form method="POST" action="{{route('jobs.store')}}" enctype="multipart/form-data" class="mx-auto"
                ...
                <div class="flex flex-wrap my-5">
                    <div class="w-full md:w-full px-6 md:mb-0 mb-6">
                        ...
                        <input type="text" id="title" name="title" onkeyup="setTitle()" class="form-input w-full block"
                            id="grid-last-name" type="text" placeholder="Título de la tarea" value="{{ old('title') }}"
                            maxlength="41">
                ...
                <div class="flex flex-wrap my-5">
                    <div class="w-full md:w-full px-6 md:mb-0 mb-1">
                        ...
                        <textarea name="description" id="description" onkeyup="setDescription()" cols="30" rows="10"
                            class="form-input w-full block" id="grid-last-name" type="text"
                            placeholder="Descripción o instrucciones de la tarea" value=""
                            maxlength="3001">{{ old('description') }}</textarea>
                ...
                <div class="flex flex-wrap my-5">
                    <div class="w-full md:w-full px-6 md:mb-0 mb-1">
                        ...
                        <input type="date" onchange="setDateStart()" id="start" name="start"
                            class="form-input w-full block" id="grid-last-name" type="text"
                            placeholder="Título de la tarea" value="{{ old('start') }}">
                ...
                <div class="flex flex-wrap my-5">
                    <div class="w-full md:w-full px-6 md:mb-0 mb-1">
                        ...
                        <input onchange="setDateStart()" type="date" id="end" name="end" class="form-input w-full block"
                            id="grid-last-name" type="text" placeholder="Título de la tarea" value="{{ old('end') }}">
                ...
                <div class="flex flex-wrap my-5">
                    <div class="w-full md:w-full px-6 md:mb-0 mb-6">
                        ...
                        <input type="text" name="link" id="link" value="{{ old('link') }}"
                            class="form-input w-full block" id="grid-last-name" type="text" placeholder="Link del video"
                            onchange="setLink()">
                        <span class="flex italic text-red-600  text-sm" role="alert" id="endError">
                            {{$errors->first('link')}}
                        </span>
