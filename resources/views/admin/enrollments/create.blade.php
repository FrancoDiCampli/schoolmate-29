        ...
        <div class="card-body py-5">
            <form method="POST" action="{{ route('enrollments.store') }}" class="mx-auto" >
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative">
                      <select id="student" name="student_id"  class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <button type="submit" class="my-5 w-8/12 mb-5 font-semibold md:w-5/12 py-2 flex mx-auto  justify-center bg-teal-600 text-gray-200 ">Save</button>
