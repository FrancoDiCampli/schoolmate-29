        ...
        <div class="flex flex-col min-h-full">
            <div class="px-6 py-4 flex justify-between items-center">
                ...
                <div class=" w-1/2">
                    ...
                    <h1 class="text-sm font-montserrat font-medium text-right text-gray-700">Total: {{$jobs}}</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-col min-h-full">
            <div class="px-6 py-4 flex justify-between items-center">
                ...
                <div class="w-1/2">
                    ...
                    <h1 class="text-sm font-montserrat font-medium text-right text-gray-700">Total: {{$activas}}</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-col min-h-full">
            <div class="px-6 py-4 flex justify-between items-center">
                ...
                <div class=" w-1/2">
                    ...
                    <h1 class="text-sm font-montserrat font-medium text-right text-gray-700">Total: {{$rechazadas}}</h1>
                </div>
            </div>
        </div>
    </div>
