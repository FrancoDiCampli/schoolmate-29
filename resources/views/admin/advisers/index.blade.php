...
<div class="card mt-6 md:w-10/12 bg-white shadow-lg p-3 rounded-sm mx-auto flex items-center justify-between">
    ...
    <div>
        <a href="{{route('adviser')}}" class="flex text-teal-600 font-semibold p-3 rounded-full hover:bg-gray-200 mx-1 focus:shadow-sm focus:outline-none">
                    ...
                    <tbody class="text-sm font-normal text-gray-700">
                        @foreach ($jobs ?? [] as $job)
                            <tr class="hover:bg-gray-100 border-b border-gray-200 bg-white text-sm">
                                ...
                                <td class="px-1 py-2">
                                    <div class="flex">
                                        <a href="{{route('jobs.showJob', $job->id)}}" class="mx-1 text-blue-400 hover:bg-gray-200 rounded-full p-2 focus:bg-gray-300">
