        ...
        <div class="card-body py-5">
            <form method="POST" action="{{ route('subjects.store') }}" class="mx-auto" >
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative">
                      <select id="teacher" onchange="setName()"  id="" name="teacher_id"  class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                ...
                <div class="flex flex-wrap my-5">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input type="text" id="subjectname" onkeyup="setName()" name="name" value="" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Escriba el nombre de la materia">
                    </div>
