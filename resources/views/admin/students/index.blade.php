...
<div class="container font-montserrat text-sm ">
    <div class="card  rounded-sm bg-gray-100 mx-auto md:mt-10 shadow-lg">
        <div
            ...
            <a href="{{route('students.create')}}">Nuevo Alumno</a>
            <a href="{{route('import.students')}}" class="bg-teal-600 text-white px-5 py-2 font-semibold">Importar
                Lista</a>
        </div>
                        ...
                        <td>
                            <form method="POST" action="{{route('user.update', $student->user->id)}}"
                                ...
                                <input type="checkbox" name="active" id=""
                                    {{$student->user->active ? 'checked' : 'false'}}>
